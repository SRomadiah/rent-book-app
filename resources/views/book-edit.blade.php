...
<div class="mt-5 w-50">
  ...
  <form action="/book-edit/{{$book->slug}}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="book_code" id="code" class="form-control" value="{{$book->book_code}}" placeholder="Book's Code" >
    </div>
    <div class="mb-3">
      <label for="title" class="form-label">Title</label>
      <input type="text" name="title" id="title" class="form-control" value="{{$book->title}}" placeholder="Book's Title" >
    </div>
    <div class="mb-3">
