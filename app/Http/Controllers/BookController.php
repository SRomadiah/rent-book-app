...
class BookController extends Controller
{
    ...
    public function update(Request $request, $slug)
    {
        ...
        return redirect('books')->with('status', 'Book Succesfully Updated');
    }
    ...
    public function destroy($slug)
    {
        $book = Book::where('slug', $slug)->first();
        $book->delete();
        return redirect('books')->with('status', 'Book Succesfully Deleted');
    }
    ...
    public function restore($slug)
    {
        ...
        $book->restore();
        return redirect('books')->with('status', 'Book Succesfully Restored');
    }
}
